...
// V4: Translation System (updated for V4)
const translations = {
  en: { appName: 'Reflect', version: 'V4', chat: 'Chat', mood: 'Mood', journal: 'Journal', exercises: 'Exercises', coping: 'Coping', programs: 'Programs', wellness: 'Wellness', network: 'Network', settings: 'Settings' },
  es: { appName: 'Reflexionar', version: 'V4', chat: 'Chat', mood: 'Estado', journal: 'Diario', exercises: 'Ejercicios', coping: 'Afrontamiento', programs: 'Programas', wellness: 'Bienestar', network: 'Red', settings: 'Configuración' },
  fr: { appName: 'Réfléchir', version: 'V4', chat: 'Chat', mood: 'Humeur', journal: 'Journal', exercises: 'Exercices', coping: 'Adaptation', programs: 'Programmes', wellness: 'Bien-être', network: 'Réseau', settings: 'Paramètres' },
        ...
        <div className="bg-white/20 backdrop-blur-lg rounded-3xl p-6 mb-4 shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Reflect V4</h1>
                <p className="text-xs text-white/60">Enhanced Security & Accessibility</p>
              </div>
            </div>
